...
class InstallWizard(Screen, ConfigListScreen):
	...
	def __init__(self, session, args = None):
		...
		if self.index == self.STATE_UPDATE:
			...
			modes = {"19e-23e": "Astra 19.2E/Hotbird 13.0E"}
	...
	def run(self):
		if self.index == self.STATE_UPDATE:
			...
			self.session.open(InstallWizardIpkgUpdater, self.index, _('Please wait (downloading channel list)'), IpkgComponent.CMD_REMOVE, {'package': 'enigma2-plugin-settings-malimali.13e.19e'})
